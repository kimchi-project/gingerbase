...
messages = {
    ...
    "GGBDR0002L": _("Updated host debug report '%(ident)s'"),
    "GGBDR0003L": _("Removed host debug report '%(ident)s'"),
    ...
    "GGBREPOS0004L": _("Enabled host software repository '%(ident)s'"),
    "GGBREPOS0005L": _("Disabled host software repository '%(ident)s'"),
}
